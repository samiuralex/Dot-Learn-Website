...
<body>
    ...
    <div class="container mt-5">
        <div class="textcenter">
            ...
            class="btn btn-warning">Add New Course</a>
        </div>
       
        <h2>Student List</h2>
        <div class="table-responsive">
            <table class="table table-bordered mt-4 n-table">
                <thead>
                    <tr>
                        
                        <th class="" scope="col">ID</th>
                        <th class="" scope="col">Course Name</th>
                        <th class="" scope="col">Course Price</th>
                        <th class="" scope="col">Teacher Fee</th>
                    </tr>
                </thead>
                <tbody>
